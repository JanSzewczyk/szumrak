...
// comment on. A successful run is already visible as the "ai-generated" PR
// itself, so this is normally reserved for failures (default icon); the
// dedup skip path in index.ts passes "ℹ️" instead. Best-effort: the env var
